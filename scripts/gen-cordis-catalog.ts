...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  GitHubProvider: 'github.md',
  GitHubRepositoryReadResult: 'github.md',
  GitHubRepositoryRevision: 'github.md',
  GitHubRepositoryTreeEntry: 'github.md',
  GitHubRepositoryFile: 'github.md',
  GitHubRepositoryFilesRequest: 'github.md',
  GitHubRepositoryRef: 'github.md',
  GitHubRepositorySearchRequest: 'github.md',
  GitHubRepositorySearchResult: 'github.md',
