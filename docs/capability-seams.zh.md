...
flowchart LR
  ...
  pkg_github["github"]
  svc_github["ctx.github<br/>GitHub repository access registry"]
  pkg_github_rest["github-rest"]
  pkg_tool_github["tool-github"]
  pkg_sdk_jsonrpc_server["sdk-jsonrpc-server"]
  svc_sdkJsonRpcIngress["ctx.sdkJsonRpcIngress<br/>JSON-RPC request admission"]
  ...
  pkg_sdk_jsonrpc_server --> svc_sdkJsonRpcIngress
  ...
  svc_sdkJsonRpcIngress --> pkg_sdk_jsonrpc_demo
...
| `ctx.github` | `seam` | [`github`](../packages/github/github) | [`github-rest`](../packages/github/github-rest) | [`tool-github`](../packages/github/tool-github) | - | REST 提供方提供结构化 github.com 事实；tool-github 负责面向模型的发现与仓库读取 schema。 |
| `ctx.sdkJsonRpcIngress` | `core` | [`sdk-jsonrpc-server`](../packages/sdk/server) | - | [`sdk-jsonrpc-demo`](../packages/examples/jsonrpc-demo) | - | 服务器拥有一个幂等 ingress gate；进程宿主只在完整外部 Cordis 配置收敛后开放它。 |
