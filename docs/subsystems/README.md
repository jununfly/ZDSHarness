...
| [github.md](github.md) | structured GitHub repository identity, facts, search/read results, provider lifecycle, and failure semantics |
| [research.md](research.md) | normalized briefs, commit-pinned evidence ledgers, Report IR validation, publication facts, and durable health |
