...
<a id="researchevaluation-completed--log-only"></a>

#### `research/evaluation-completed` — log-only
...
来源：[`packages/research/research/src/health.ts:100`](../packages/research/research/src/health.ts)

<a id="researchevidence-collected--log-only"></a>

#### `research/evidence-collected` — log-only
...
来源：[`packages/research/research/src/health.ts:94`](../packages/research/research/src/health.ts)

<a id="researchreport-prepared--log-only"></a>

#### `research/report-prepared` — log-only
...
来源：[`packages/research/research/src/health.ts:96`](../packages/research/research/src/health.ts)

<a id="researchreport-published--log-only"></a>

#### `research/report-published` — log-only
...
来源：[`packages/research/research/src/health.ts:98`](../packages/research/research/src/health.ts)
